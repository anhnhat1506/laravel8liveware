<div>
    ...
    <div class="row setup-content {{ $currentStep != 1 ? 'display-none' : '' }}" id="step-1">
        <div class="col-md-12">
            ...
            <button class="btn btn-primary nextBtn btn-lg pull-right" wire:click="firstStepSubmit">Next</button>
        </div>
    </div>
    <div class="row setup-content {{ $currentStep != 2 ? 'display-none' : '' }}" id="step-2">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" wire:click="back(1)">Back</button>
            </div>
        </div>
    </div>
    <div class="row setup-content {{ $currentStep != 3 ? 'display-none' : '' }}" id="step-3">
        <div class="col-md-12">
            ...
            <button class="btn btn-danger btn-lg pull-right" wire:click="back(2)" type="button">Back</button>
        </div>
    </div>
</div>
